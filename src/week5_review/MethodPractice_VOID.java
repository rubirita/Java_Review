...
public class MethodPractice_VOID {
    ...
    public static void calculate(double num1, char mathOperator, double num2) {
        ...
        //ako zelim da ovaj metod racuna samo pozitivne brojeve odmah stavim:
        if (num1<0 || num2<0){
            System.out.println("One " + num1 + " or " + num2 + " is not positive.");
            return;// DA OVDE STANE UKOLIKO JE OVAJ IF TACAN.
        }
